...
public class PeliculasController {
	...
	public Pelicula obtenerPelicula(@PathVariable int id) {
		if (id > 0) {
	...
	public ResponseEntity<String> actualizarPelicula(@PathVariable int id, @RequestBody Pelicula pelicula) {
		...
		return new ResponseEntity<>("La pelicula no fue encontrada o no se pudo actualizar de forma correcta",
